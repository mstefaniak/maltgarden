...
import C, * as _rest from '../../_pages/beers/[...slug]'
...
export const getStaticProps = async (ctx) => {
  ...
  const ns0 = await import(`../../locales/${_lang}/common`).then(
    (m) => m.default
  )
  const ns1 = await import(`../../locales/${_lang}/beer`).then((m) => m.default)
  const _ns = { common: ns0, beer: ns1 }
